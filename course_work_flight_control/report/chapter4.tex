...
\begin{figure}[H]
    ...
    \centering
    \resizebox{1.1\linewidth}{!}{\input{./figures/model_DD_Delta_H.pgf}}
    ...
    \begin{minipage}{0.48\textwidth}
    \centering
    \resizebox{1.1\linewidth}{!}{\input{./figures/model_DD_delta_elevator.pgf}}
...
\begin{figure}[H]
    \begin{minipage}{0.48\textwidth}
    \centering
    \resizebox{1.1\linewidth}{!}{\input{./figures/model_DD_omega_z.pgf}}
    ...
    \begin{minipage}{0.48\textwidth}
    \centering
    \resizebox{1.1\linewidth}{!}{\input{./figures/model_DD_theta.pgf}}
...
\begin{figure}[H]
    \begin{minipage}{0.48\textwidth}
    \centering
    \resizebox{1.1\linewidth}{!}{\input{./figures/model_Delta_H.pgf}}
    ...
    \begin{minipage}{0.48\textwidth}
    \centering
    \resizebox{1.1\linewidth}{!}{\input{./figures/model_delta_elevator.pgf}}
...
\begin{figure}[H]
    \begin{minipage}{0.48\textwidth}
    \centering
    \resizebox{1.1\linewidth}{!}{\input{./figures/model_omega_z.pgf}}
    ...
    \begin{minipage}{0.48\textwidth}
    \centering
    \resizebox{1.1\linewidth}{!}{\input{./figures/model_theta.pgf}}

...
def interpolate_H(M, P, H, H_int):
    ...
    for i in range(0, len(P_up)):
        P_f = interpolate.interp1d([H_up, H_down], [P_up[i], P_down[i]], fill_value="extrapolate")
        P_int.append(P_f(H_int))
        M_f = interpolate.interp1d([H_up, H_down], [M_up[i], M_down[i]], fill_value="extrapolate")

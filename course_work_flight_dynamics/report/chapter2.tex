...
\begin{sidewaystable}[ph!]
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
            ...
            \resizebox{\textwidth}{!}{\input{./figures/P_H=0.0.pgf}}}
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/Cy_H=0.0.pgf}}}
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/V_y_H=0.0.pgf}}}
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/q_km_ch_together_H=0.0.pgf}}}
...
\begin{sidewaystable}[ph!]
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
            \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
            \resizebox{\textwidth}{!}{\input{./figures/P_H=2.0.pgf}}}
            \caption{График располагаемой и потребной тяги}
            \label{fig:P_H_2}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/Cy_H=2.0.pgf}}}
        \caption{График $C_{y_{доп}}, \, C_{y_n}$}
        \label{fig:Cy_2}
        \end{figure}
    \end{minipage} \\
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/V_y_H=2.0.pgf}}}
        \caption{График $V_y^*(M, H)$}
        \label{fig:Vy_2}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/q_km_ch_together_H=2.0.pgf}}}
        \caption{График $q_{км},\, q_{ч}$}
        \label{fig:q_2}
        \end{figure}
    \end{minipage} \\
...
\begin{sidewaystable}[ph!]
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
            \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
            \resizebox{\textwidth}{!}{\input{./figures/P_H=4.0.pgf}}}
            \caption{График располагаемой и потребной тяги}
            \label{fig:P_H_4}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/Cy_H=4.0.pgf}}}
        \caption{График $C_{y_{доп}}, \, C_{y_n}$}
        \label{fig:Cy_4}
        \end{figure}
    \end{minipage} \\
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/V_y_H=4.0.pgf}}}
        \caption{График $V_y^*(M, H)$}
        \label{fig:Vy_4}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/q_km_ch_together_H=4.0.pgf}}}
        \caption{График $q_{км},\, q_{ч}$}
        \label{fig:q_4}
        \end{figure}
    \end{minipage} \\
...
\begin{sidewaystable}[ph!]
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
            \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
            \resizebox{\textwidth}{!}{\input{./figures/P_H=6.0.pgf}}}
            \caption{График располагаемой и потребной тяги}
            \label{fig:P_H_6}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/Cy_H=6.0.pgf}}}
        \caption{График $C_{y_{доп}}, \, C_{y_n}$}
        \label{fig:Cy_6}
        \end{figure}
    \end{minipage} \\
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/V_y_H=6.0.pgf}}}
        \caption{График $V_y^*(M, H)$}
        \label{fig:Vy_6}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/q_km_ch_together_H=6.0.pgf}}}
        \caption{График $q_{км},\, q_{ч}$}
        \label{fig:q_6}
        \end{figure}
    \end{minipage} \\
...
\begin{sidewaystable}[ph!]
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
            \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
            \resizebox{\textwidth}{!}{\input{./figures/P_H=8.0.pgf}}}
            \caption{График располагаемой и потребной тяги}
            \label{fig:P_H_8}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/Cy_H=8.0.pgf}}}
        \caption{График $C_{y_{доп}}, \, C_{y_n}$}
        \label{fig:Cy_8}
        \end{figure}
    \end{minipage} \\
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/V_y_H=8.0.pgf}}}
        \caption{График $V_y^*(M, H)$}
        \label{fig:Vy_8}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/q_km_ch_together_H=8.0.pgf}}}
        \caption{График $q_{км},\, q_{ч}$}
        \label{fig:q_8}
        \end{figure}
    \end{minipage} \\
...
\begin{sidewaystable}[ph!]
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
            \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
            \resizebox{\textwidth}{!}{\input{./figures/P_H=10.0.pgf}}}
            \caption{График располагаемой и потребной тяги}
            \label{fig:P_H_10}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/Cy_H=10.0.pgf}}}
        \caption{График $C_{y_{доп}}, \, C_{y_n}$}
        \label{fig:Cy_10}
        \end{figure}
    \end{minipage} \\
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/V_y_H=10.0.pgf}}}
        \caption{График $V_y^*(M, H)$}
        \label{fig:Vy_10}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/q_km_ch_together_H=10.0.pgf}}}
        \caption{График $q_{км},\, q_{ч}$}
        \label{fig:q_10}
        \end{figure}
    \end{minipage} \\
...
\begin{sidewaystable}[ph!]
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
            \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
            \resizebox{\textwidth}{!}{\input{./figures/P_H=12.0.pgf}}}
            \caption{График располагаемой и потребной тяги}
            \label{fig:P_H_12}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/Cy_H=12.0.pgf}}}
        \caption{График $C_{y_{доп}}, \, C_{y_n}$}
        \label{fig:Cy_12}
        \end{figure}
    \end{minipage} \\
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/V_y_H=12.0.pgf}}}
        \caption{График $V_y^*(M, H)$}
        \label{fig:Vy_12}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/q_km_ch_together_H=12.0.pgf}}}
        \caption{График $q_{км},\, q_{ч}$}
        \label{fig:q_12}
        \end{figure}
    \end{minipage} \\
...
\begin{sidewaystable}[ph!]
    ...
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
            \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
            \resizebox{\textwidth}{!}{\input{./figures/P_H=12.4.pgf}}}
            \caption{График располагаемой и потребной тяги}
            \label{fig:P_H_12_4}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/Cy_H=12.4.pgf}}}
        \caption{График $C_{y_{доп}}, \, C_{y_n}$}
        \label{fig:Cy_12_4}
        \end{figure}
    \end{minipage} \\
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/V_y_H=12.4.pgf}}}
        \caption{График $V_y^*(M, H)$}
        \label{fig:Vy_12_4}
        \end{figure}
    \end{minipage} &
    \begin{minipage}{0.45\textheight}
        \begin{figure}[H]
        \adjustbox{trim=16pt 2pt 24pt 28pt,clip}{
        \resizebox{\textwidth}{!}{\input{./figures/q_km_ch_together_H=12.4.pgf}}}
        \caption{График $q_{км},\, q_{ч}$}
        \label{fig:q_12_4}
        \end{figure}
    \end{minipage} \\
...
\begin{figure}[H]
\centering
%\resizebox{.79\linewidth}{!}{\input{./figures/V_y_H.pgf}}
\input{./figures/H_M_flight_area.pgf}
...
\begin{figure}[H]
    \centering
    \resizebox{.79\linewidth}{!}{\input{./figures/q_km_q_ch.pgf}}

...
\begin{table}[H]
    ...
    \input{./tables/H_const_V_opt_v2_step_60_result.tex}
\end{table}

\begin{figure}[H]
    \begin{minipage}{0.49\textwidth}
    \centering
    \resizebox{\textwidth}{!}{\input{./img/H_const_V_opt_v2_step_1_L_H.pgf}}
    ...
    \begin{minipage}{0.49\textwidth}
    \centering
    \resizebox{\textwidth}{!}{\input{./img/H_const_V_opt_v2_step_1_L_m.pgf}}
...
\begin{table}[H]
    ...
    \input{./tables/H_opt_V_opt_v2_step_1_result.tex}
\end{table}

\begin{figure}[H]
    \begin{minipage}{0.49\textwidth}
    \centering
    \resizebox{\textwidth}{!}{\input{./img/H_opt_V_opt_v2_step_1_L_H.pgf}}
    \caption{График зависимости $H(L)$ и $V(L)$}
    ...
    \begin{minipage}{0.49\textwidth}
    \centering
    \resizebox{\textwidth}{!}{\input{./img/H_opt_V_opt_v2_step_1_L_m.pgf}}
    \caption{График зависимости $q(L)$ и $m(L)$}
    \label{fig:H_opt_L_m}
    \end{minipage}
\end{figure}
...
\begin{table}[H]
    ...
    \input{./tables/H_300_V_opt_v2_step_60_result.tex}
\end{table}

\begin{figure}[H]
    \begin{minipage}{0.49\textwidth}
    \centering
    \resizebox{\textwidth}{!}{\input{./img/H_300_V_opt_v2_step_60_L_H.pgf}}
    \caption{График зависимости $H(L)$ и $V(L)$}
    ...
    \begin{minipage}{0.49\textwidth}
    \centering
    \resizebox{\textwidth}{!}{\input{./img/H_300_V_opt_v2_step_60_L_m.pgf}}
    \caption{График зависимости $q(L)$ и $m(L)$}
    \label{fig:H_300_L_m}
    \end{minipage}
\end{figure}

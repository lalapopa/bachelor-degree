...
\begin{frame}
    ...
    \begin{center}
        ...
        \resizebox{\textwidth}{!}{
            {\input{../course_work_flight_dynamics/report/figures/P_rasp_P_potr_combine.pgf}}
        }
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
        ...
        \resizebox{0.75\textwidth}{!}{
            {\input{../course_work_flight_dynamics/report/figures/H_M_flight_area.pgf}}
        }
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.70\linewidth}{!}{\input{../course_work_flight_dynamics/report//figures/V_y_H.pgf}}
    \end{center}
\end{frame}
\begin{frame}[t]
    \frametitle{Расчет летно-технических характеристик}
    \begin{center}
        ...
        \resizebox{.70\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/q_km_q_ch.pgf}}
    \end{center}
\end{frame}
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \input{../course_work_flight_dynamics/report/tables/climb_mini_table.tex}
        \vfill

        Параметры крейсерского полета:

        \input{../course_work_flight_dynamics/report/tables/level_flight_data.tex}
        \vfill
        Параметры  при снижении высоты:

        \input{../course_work_flight_dynamics/report/tables/descent_mini_table.tex}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.70\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/H_L_graph.pgf}}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.70\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/m_L_graph.pgf}}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \input{../course_work_flight_dynamics/report/tables/takeoff_landing_table.tex}
    \end{center}
    \vfill
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.70\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/turn_graph.pgf}}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.70\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/xTP_graph.pgf}}
    \end{center} 
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.70\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/phi_bal_graph.pgf}}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{0.70\textwidth}{!}{\input{../course_work_flight_dynamics/report/figures/phi_n_graph.pgf}}
    \end{center}
\end{frame}
    ...
    \begin{center}
        ...
        \begin{minipage}{0.45\textwidth}
            \begin{center}
                ...
                \resizebox{\textwidth}{!}{\input{../course_work_flight_control/report/figures/K_omega_z_H_q.pgf}}
            \end{center}
        \end{minipage}
        \hfill
        \begin{minipage}{0.45\textwidth}
            \begin{center}
                ...
                \resizebox{\textwidth}{!}{\input{../course_work_flight_control/report/figures/K_theta_H_q.pgf}}
            \end{center}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \begin{center}
                Для регулятора $i_H$\\
                \resizebox{\textwidth}{!}{\input{../course_work_flight_control/report/figures/i_H_H_q.pgf}}
            \end{center}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \begin{center}
                Для регулятора $K_H$\\
                \resizebox{\textwidth}{!}{\input{../course_work_flight_control/report/figures/K_H_H_q.pgf}}
            \end{center}
        \end{minipage}
    \end{center}
\end{frame}
        ...
        \begin{picture}(290, 190)
            \put(-30,30){
                \adjustbox{trim=10pt 3pt 18pt 20pt,clip}{
                    \resizebox{0.65\textwidth}{!}{\input{../course_work_flight_control/report/figures/altitude_ol.pgf}}
            }}
            \put(180, 137){
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \begin{center}
                \resizebox{1.0\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_Delta_H_s.pgf}}
            \end{center}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \begin{center}
                \resizebox{1.0\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_delta_elevator_s.pgf}}
            \end{center}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \begin{center}
                \resizebox{1.0\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_omega_z_s.pgf}}
            \end{center}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \begin{center}
                \resizebox{1.0\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_theta_s.pgf}}
            \end{center}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \begin{center}
                \resizebox{1.0\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_DD_Delta_H_s.pgf}}
            \end{center}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \begin{center}
                \resizebox{1.0\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_DD_delta_elevator_s.pgf}}
            \end{center}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \begin{center}
                \resizebox{\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_DD_omega_z_s.pgf}}
            \end{center}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \begin{center}
                \resizebox{\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_DD_theta_s.pgf}}
            \end{center}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{\textwidth}
            \begin{table}[H]
                \centering
                \resizebox{0.65\textwidth}{!}{\input{long_range_cruise_contorl_table.tex}}
            \end{table}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_const_V_opt_v2_step_60_L_H.pgf}}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_const_V_opt_v2_step_60_L_m.pgf}}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_opt_V_opt_v2_step_1_L_H.pgf}}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_opt_V_opt_v2_step_1_L_m.pgf}}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_300_V_opt_v2_step_60_L_H.pgf}}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{
            \input{../special_part/report/img/H_300_V_opt_v2_step_60_L_m.pgf}}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{0.7\textwidth}{!}{\input{./figures/funny_plot.pgf}}
    \end{center}
\end{frame}

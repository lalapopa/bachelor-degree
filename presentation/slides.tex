...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{!}{0.7\textheight}{\input{../course_work_flight_control/report/figures/altitude_ol.pgf}}
    \end{center}
\end{frame}
...
\begin{center}
    ...
    \begin{minipage}{\textwidth}
        \begin{table}[H]
            \centering
            \resizebox{0.55\textwidth}{!}{\input{long_range_cruise_contorl_table.tex}}
        \end{table}
    \end{minipage}
\end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_const_V_opt_L_H.pgf}}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_const_V_opt_L_m.pgf}}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_opt_V_opt_L_H.pgf}}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_opt_V_opt_L_m.pgf}}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_300_V_opt_L_H.pgf}}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{
            \input{../special_part/report/img/H_300_V_opt_L_m.pgf}}
        \end{minipage}
    \end{center}
\end{frame}

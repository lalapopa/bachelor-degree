...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.79\linewidth}{!}{\input{../course_work_flight_dynamics/report//figures/V_y_H.pgf}}
    \end{center}
\end{frame}
\begin{frame}[t]
    \frametitle{Расчет летно-технических характеристик}
    \begin{center}
        ...
        \resizebox{.79\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/q_km_q_ch.pgf}}
    \end{center}
\end{frame}
\begin{frame}[t]
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.79\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/H_L_graph.pgf}}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.79\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/m_L_graph.pgf}}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.79\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/turn_graph.pgf}}
    \end{center}
\end{frame}
...
\begin{frame}[t]
   ...
   \begin{center}
       ...
       \resizebox{.79\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/xTP_graph.pgf}}
   \end{center} 
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.79\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/phi_bal_graph.pgf}}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{.79\linewidth}{!}{\input{../course_work_flight_dynamics/report/figures/phi_n_graph.pgf}}
    \end{center}
\end{frame}
...
\begin{center}
    ...
    \vspace{14pt}
        ...
        \begin{minipage}{0.45\textwidth}
            \begin{center}
            \resizebox{1.2\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_Delta_H.pgf}}
            \end{center}
        \end{minipage}
        \hfill
        \begin{minipage}{0.45\textwidth}
            \begin{center}
                \resizebox{1.2\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_delta_elevator.pgf}}
            \end{center}
        \end{minipage}
\end{center}
\end{frame}
...
\begin{center}
    ...
    \vspace{14pt}
        ...
        \begin{minipage}{0.45\textwidth}
            \begin{center}
            \resizebox{1.2\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_omega_z.pgf}}
            \end{center}
        \end{minipage}
        \hfill
        \begin{minipage}{0.45\textwidth}
            \begin{center}
                \resizebox{1.2\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_theta.pgf}}
            \end{center}
        \end{minipage}
\end{center}
\end{frame}
...
\begin{center}
    ...
    \vspace{14pt}
        ...
        \begin{minipage}{0.45\textwidth}
            \begin{center}
            \resizebox{1.2\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_DD_Delta_H.pgf}}
            \end{center}
        \end{minipage}
        \hfill
        \begin{minipage}{0.45\textwidth}
            \begin{center}
                \resizebox{1.2\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_DD_delta_elevator.pgf}}
            \end{center}
        \end{minipage}
\end{center}
\end{frame}
...
\begin{center}
    ...
    \vspace{14pt}
        ...
        \begin{minipage}{0.45\textwidth}
            \begin{center}
            \resizebox{1.2\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_DD_omega_z.pgf}}
            \end{center}
        \end{minipage}
        \hfill
        \begin{minipage}{0.45\textwidth}
            \begin{center}
                \resizebox{1.2\textwidth}{!}{\input{../course_work_flight_control/report/figures/model_DD_theta.pgf}}
            \end{center}
        \end{minipage}
\end{center}
\end{frame}
...
\begin{center}
    ...
    \begin{minipage}{\textwidth}
        \begin{table}[H]
            \centering
            \resizebox{0.6\textwidth}{!}{\input{long_range_cruise_contorl_table.tex}}
        \end{table}
    \end{minipage}
\end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \centering
            \adjustbox{trim=0pt 2pt 0pt 0pt,clip}{
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_300_V_opt_L_m.pgf}}}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \resizebox{0.8\textwidth}{!}{\input{./figures/funny_plot.pgf}}
    \end{center}
\end{frame}

...
\begin{frame}[t]
    ...
    \begin{center}
        ...
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_const_V_opt_v2_step_1_L_H.pgf}}
        \end{minipage}
        \hfill
        \begin{minipage}{0.49\textwidth}
            \centering
            \resizebox{1.0\textwidth}{!}{\input{../special_part/report/img/H_const_V_opt_v2_step_1_L_m.pgf}}
        \end{minipage}
    \end{center}
\end{frame}
